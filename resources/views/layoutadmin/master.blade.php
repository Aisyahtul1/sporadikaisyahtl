...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Sporadik - <b>Admin</b></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="/layoutadmin/home" class="nav-link">
            ...
            <li class="nav-item">
                <a href="/sporadik" class="nav-link">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">Aisyah</a>.</strong> All rights reserved.
  </footer>
